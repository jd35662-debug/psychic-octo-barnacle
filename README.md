...
- Seeded connected-room maze generation assembled from rooms, corridors, doors, and loop-back hallways.
...
- Press `E` while facing a nearby wall seam or door outline to carve a new connected doorway and generate a room beyond it.
- Landmark and rare unusual rooms, including extremely large rooms, for environmental storytelling.
- Lightweight raycast renderer with low-resolution pixelated presentation, fog, wallpaper bands, door outlines, light variation, and flickering lights.
